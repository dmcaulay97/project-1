...
function getLocation() {
    return fetch("https://ipgeolocation.abstractapi.com/v1/?api_key=ae719e5173304649b7f31e033c8a5ecf")
        .then(function (response) {
            return response.json()
                .then(function (data) {
                    ...
                    //console.log(lat, lon);
                    // var geohash = Geohash.encode(52.20, 0.12, 6);
                    // console.log(geohash);
                    // var geohash = Geohash.encode(lat, lon, 6);
                    // console.log(geohash);
                })
        })
}
...
//     fetch("http://geohash.world/v1/encode/" + lat + "," + lon + "?pre=6")
//         .then(function (response) {
//             if (response.ok) {
//                 response.json()
//                     .then(function (data) {
